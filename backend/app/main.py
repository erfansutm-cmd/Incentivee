...
def _ensure_cities_table() -> None:
    ...
    The DDL is generated by SQLAlchemy, so there is no database-specific
    code here — the same path works with MySQL or any other engine.
    """
